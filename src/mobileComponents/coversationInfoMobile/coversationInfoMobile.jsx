...
import "./coversationInfoMobile.css";

const CoversationInfoMobile = ({ conversation, handleConversationClick }) => {
  ...
  return (
    ...
    >
      <div className="messageInfo">
        <PhotoIcon />
        <div>
          <p style={{ fontSize: "12px" }}>{conversation.name}...</p>
          <p>
...
export default CoversationInfoMobile;
